...
class Checkme_Helper(Checkme):

    # HEADER
    def click_the_names_header(self):
        return self.find_element(locator=Page_Locators.NAME_HEADER_XPATH_LOCATOR, time=2).click()

    def click_the_counts_header(self):
        return self.find_element(locator=Page_Locators.COUNT_HEADER_XPATH_LOCATOR, time=2).click()

    def click_the_prices_header(self):
        return self.find_element(locator=Page_Locators.PRICE_HEADER_XPATH_LOCATOR, time=2).click()

    def click_the_actions_header(self):
        return self.find_element(locator=Page_Locators.ACTION_HEADER_XPATH_LOCATOR, time=2).click()

    # BUTTONS
    def click_the_open_button(self):
        return self.find_element(locator=Page_Locators.OPEN_BUTTON_ID_LOCATOR, time=2).click()

    def click_the_discard_button(self):
        return self.find_element(locator=Page_Locators.DISCARD_BUTTON_XPATH_LOCATOR, time=2).click()

    def click_the_add_button(self):
        return self.find_element(locator=Page_Locators.ADD_BUTTON_ID_LOCATOR, time=2).click()

    def click_the_delete_record(self, n):
        return self.find_element(locator=(By.XPATH, f"{Page_Locators.TABLE_CONTENT_XPATH_LOCATOR[1]}/tr[{n}]/td/a[@class='delete']"), time=2).click()

    # FIELDS
    def enter_name(self, name=None):
        name_field = self.find_element(locator=Page_Locators.INPUT_NAME_FIELD_ID_LOCATOR, time=2)
        if name:
            name_field.click()
    ...
    def enter_count(self, count=None):
        count_field = self.find_element(locator=Page_Locators.INPUT_COUNT_FIELD_ID_LOCATOR, time=2)
        if count:
            count_field.click()
    ...
    def enter_price(self, price=None):
        price_field = self.find_element(locator=Page_Locators.INPUT_PRICE_FIELD_ID_LOCATOR, time=2)
        if price:
            price_field.click()
